...
export const PROVIDERS = {
  ...
  options: [
    ...
    { value: "gemini", label: "constants.geminiName" },
    { value: "google-gemini-cli", label: "constants.googleGeminiCliName" },
  ...
  labels: {
    ...
    gemini: "constants.geminiName",
    "google-gemini-cli": "constants.googleGeminiCliName",
  ...
  setup: [
    ...
    },
    {
      ...
      name: "constants.googleGeminiCliName",
      desc: "constants.googleGeminiCliDesc",
      tag: "",
      envKey: "",
...
export const SETTINGS_SECTIONS: SectionDef[] = [
  {
    ...
    items: [
      ...
      {
        key: "GEMINI_API_KEY",
        label: "constants.geminiApiKey",
        type: "password",
        hint: "constants.geminiHint",
      },
      {
        key: "HERMES_GEMINI_PROJECT_ID",
        label: "constants.geminiProjectId",
        type: "text",
        hint: "constants.geminiProjectHint",
      },
      {
        key: "XAI_API_KEY",
