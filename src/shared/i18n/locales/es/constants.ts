export default {
  ...
  googleGeminiCliDesc: "Usa tu cuenta iniciada en Gemini CLI",
  xaiName: "xAI (Grok)",
  ...
  geminiHint: "Variable alternativa para la API key de Gemini",
  geminiProjectId: "ID de proyecto de Gemini CLI",
  geminiProjectHint:
    "Proyecto opcional de Google Cloud para OAuth de Gemini CLI",
