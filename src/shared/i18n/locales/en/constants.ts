export default {
  ...
  geminiName: "Gemini API",
  googleGeminiCliName: "Gemini CLI (OAuth)",
  googleGeminiCliDesc: "Use your logged-in Gemini CLI account",
  xaiName: "xAI (Grok)",
  xaiDesc: "Grok models",
  ...
  geminiHint: "Alternative Gemini API key env var",
  geminiProjectId: "Gemini CLI Project ID",
  geminiProjectHint: "Optional Google Cloud project for Gemini CLI OAuth",
  ...
  signalHttpUrl: "Signal CLI HTTP URL",
  signalHttpUrlHint: "signal-cli REST API URL, e.g. http://localhost:8080",
  signalAccount: "Signal Account",
  signalAccountHint: "Phone number or UUID used as signal-cli account identifier",
