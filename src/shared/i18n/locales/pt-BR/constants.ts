export default {
  ...
  googleGeminiCliDesc: "Use sua conta logada no Gemini CLI",
  xaiName: "xAI (Grok)",
  ...
  geminiHint: "Variável alternativa para chave de API Gemini",
  geminiProjectId: "ID do projeto Gemini CLI",
  geminiProjectHint:
    "Projeto opcional do Google Cloud para OAuth do Gemini CLI",
