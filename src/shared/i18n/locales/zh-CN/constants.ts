export default {
  ...
  googleGeminiCliDesc: "使用已登录的 Gemini CLI 账户",
  xaiName: "xAI (Grok)",
  xaiDesc: "Grok 模型",
  ...
  geminiHint: "Gemini API Key 的备用环境变量",
  geminiProjectId: "Gemini CLI 项目 ID",
  geminiProjectHint: "Gemini CLI OAuth 可选 Google Cloud 项目",
